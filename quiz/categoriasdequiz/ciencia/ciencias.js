...
const questions = [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "Fricção", correct: false },
            { text: "Inércia", correct: false }
        ]
    },
    {
        question: "Qual órgão do corpo humano é responsável pela bombagem do sangue?",
        answers: [
    ...
    {
        question: "Qual é o estado físico da água a 0°C sob pressão normal?",
        answers: [
            { text: "Sólido", correct: true },
            { text: "Gás", correct: false },
